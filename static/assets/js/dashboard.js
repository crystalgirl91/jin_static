...
var Dashboard = function () {
    ...
    return {
        ...
        init: function () {
            ...
            $.getScript('/static/assets/plugins/gritter/js/jquery.gritter.js').done(function() {
                handleDashboardGritterNotification();
            });
            
            $.getScript('/static/assets/plugins/flot/jquery.flot.min.js').done(function() {
                $.getScript('/static/assets/plugins/flot/jquery.flot.time.min.js').done(function() {
                    $.getScript('/static/assets/plugins/flot/jquery.flot.resize.min.js').done(function() {
                        $.getScript('/static/assets/plugins/flot/jquery.flot.pie.min.js').done(function() {
            ...
            $.getScript('/static/assets/plugins/sparkline/jquery.sparkline.js').done(function() {
                handleDashboardSparkline();
            });
            
            $.getScript('/static/assets/plugins/jquery-jvectormap/jquery-jvectormap-1.2.2.min.js').done(function() {
                $.getScript('/static/assets/plugins/jquery-jvectormap/jquery-jvectormap-world-mill-en.js').done(function() {
                    handleVectorMap();
                });
            });
            
            $.getScript('/static/assets/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js').done(function() {
